...
def load_model(aqi_path: str, pm_path, device) -> nn.Module:
    ...
    aqi_model.load_state_dict(torch.load(aqi_path))
    aqi_model.eval()
    fsp_model.load_state_dict(torch.load(pm_path))
    fsp_model.eval()
...
def main():
    ...
    aqi_scalers_path = "./data/x_scalers_aqi.pkl"
    fsp_scalers_path = "./data/x_scalers_fsp.pkl"
    stations_csv = "./data/stations_epd_idx.csv"
    aqi_model_path = "./data/cnn_lstm_aqi.pth"
    fsp_model_path = "./data/cnn_lstm_fsp.pth"
